...
public class HotelReservationMain extends Frame implements ActionListener, ItemListener, MouseListener, KeyListener, WindowListener{
     ...
     private JComboBox checkInMonth, checkInDay, checkInYear, checkOutMonth,checkOutDay,checkOutYear; //provides a simple dropdown menu
     ...
     public HotelReservationMain() {
    	 ...
    	 //calling in the methods that set up the GUI and the buttons
    	 reservationInfo();
    	 reservationButtons();
    	 
    	 //adding components to the main frame and setting up their positions
 		 ...
 		 */
       	...
       	//setting up the event listeners and intializing database
     ...
     public void getData() {
    	    ...
    	    String selectedCheckInMonth  = (String) checkInMonth.getSelectedItem();
    	    String selectedCheckInDay = (String) checkInDay.getSelectedItem();
    	    String selectedCheckInYear  = (String) checkInYear.getSelectedItem();
    	    ...
    	    String selectedCheckOutMonth = (String) checkOutMonth.getSelectedItem();
    	    String selectedCheckOutDay = (String) checkOutDay.getSelectedItem();
    	    String selectedCheckOutYear = (String) checkOutYear.getSelectedItem();
	...
	public void resetComponents() {
	    ...
	    checkInMonth.setSelectedIndex(currentMonth);
		checkInYear.setSelectedItem(currentYear);
		checkInDay.setSelectedItem(currentDay);
		checkOutMonth.setSelectedIndex(currentMonth);
		checkOutYear.setSelectedItem(currentYear);
		checkOutDay.setSelectedItem(currentDay);
	...
	public void mouseClicked(MouseEvent e) {
	    if (e.getSource().equals(reservationTable)) {
	        ...
	        checkInMonth.setSelectedItem(checkInParts[0]);
	        checkInDay.setSelectedItem(checkInParts[1].replace(",", ""));
	        checkInYear.setSelectedItem(checkInParts[2]);

	        
	        //Check-out
	        String checkOutDate = reservationTable.getValueAt(i, 4).toString();
	        String[] checkOutParts = checkOutDate.split(" ");
	        checkOutMonth.setSelectedItem(checkOutParts[0]);
	        checkOutDay.setSelectedItem(checkOutParts[1].replace(",", ""));
	        checkOutYear.setSelectedItem(checkOutParts[2]);
